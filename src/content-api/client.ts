...
import type { BaseComment, BaseCommentParam, BaseCommentWithParent, CommentWithHasChildren, Page, Response } from './types'
...
export class CommentClient {
    ...
    public listTopComments(
        ...
        targetId: number,
        params?: { page: number; size?: number; sort?: Array<string> },
